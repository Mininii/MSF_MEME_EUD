...
CIf(FP,{TMemoryX(_Add(RPtr,40),AtLeast,150*16777216,0xFF000000)})
	...
	CTrigger(FP,{CV(RUID,40)},{--부르드링 리무브타이머 제거
		...
		CIfEnd()
			...
			CElseIfX_AddRepeatType(127,"Attack_Parasite")
				f_Read(FP,_Add(RPtr,10),CPos)
				Convert_CPosXY()
				Simple_SetLocX(FP,0,CPosX,CPosY,CPosX,CPosY,{Simple_CalcLoc(0,-4,-4,4,4)})
				CTrigger(FP, {CV(Repeat_OrderType,0)}, {TOrder(RUID, RPID, 1, Attack, RLocV);}, {preserved})
				CDoActions(FP,{TSetMemoryX(_Add(RPtr,8),SetTo,127*65536,0xFF0000),TSetDeathsX(_Add(RPtr,72),SetTo,0xFF*256,0,0xFF00)})
